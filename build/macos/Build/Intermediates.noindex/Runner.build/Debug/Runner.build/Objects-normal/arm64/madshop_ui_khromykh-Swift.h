...
#ifndef MADSHOP_UI_KHROMYKH_SWIFT_H
#define MADSHOP_UI_KHROMYKH_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="madshop_ui_khromykh",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC19madshop_ui_khromykh11AppDelegate")
...
SWIFT_CLASS("_TtC19madshop_ui_khromykh17MainFlutterWindow")
